...
Release in May'17">
    ...
    <title>ShareCloth.com – Features VR</title>
...
<?php include "../_blue_menu.php";?>


<div id="barba-wrapper">
    <div class="barba-container">
        <div id="feature-boxed">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 feature-item">
                        <i class="fa fa-picture-o feature-icon"></i>
                    ...
                    <div class="col-md-4 feature-item">
                        <i class="fa fa-mobile-phone feature-icon"></i>

                        <div class="text">
                            <h5>Shareable content</h5>
                            <p>Allow the customers to share and consume their discoveries on any device</p>
                        </div>
